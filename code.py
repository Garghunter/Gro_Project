...
class Log_in(tk.Frame):
    def __init__(self, master=None):
        ...
        self.forpass_button = tk.Button(self, text='Check Password', command=self.forpass,font=('arial', 15))
    ...
    def fop(self):
        ...
        if con.is_connected():
            ...
            if emailcheck(Email):
                    ...
                    rows = c1.fetchall()
                    for x in rows:
                        self.label = tk.Label(self, text="your Password is --> {}".format(x[3]), font=("Arial", 10))
                        self.label.pack(pady=5)
                    c1.close()
            else:
                self.label = tk.Label(self, text="Incorrect email", font=("Arial", 10))
...
class py_fr4(tk.Frame):
    ...
    def ne(self):
        ...
        if con.is_connected():
            ...
            con.commit()
            con.close
            self.label = tk.Label(self, text='Your Course Is Complete \n '
                                             'Thank You For Choosing \n'
                                             'GroIntern \n Live learning live growth', font=("Arial", 20))
...
class py_ad_fr4(tk.Frame):
    ...
    def ne(self):
        ...
        if con.is_connected():
            ...
            con.commit()
            con.close
            self.label1= tk.Label(self, text='Your Course Is Complete \n '
                                             'Thank You For Choosing \n'
                                             'GroIntern \n Live learning live growth', font=("Arial", 20))
